...
/*
  The PC tower and the built-in desk slab used to be hidden here at runtime with
  a traverse over the whole hierarchy — downloaded and uploaded to VRAM only to
  be invisible. They are now stripped from the model itself by
  scripts/strip-model.mjs, and from this file by scripts/codemod-muha.mjs, so
  there is nothing left to hide. src/components/towerHidden.js survives purely
  as the build-time manifest of what to remove.
*/
...
// preload lives in src/utils/preloadScenes.js — see the note in Desk.jsx
