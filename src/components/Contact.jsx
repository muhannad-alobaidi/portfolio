...
const Contact = () => {
  return (
    <section
      id="contact"
      className=" m-auto mt-[250px] p-6 md:p-24 items-center  flex-col md:flex-row w-[100%] max-w-[1024px] gap-10 border border-neon/15 rounded-lg backdrop-blur-[4px] z-[999] "
    >
